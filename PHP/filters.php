...
echo $myUsername;
// email example
$myEmail = 'sam@    completewebdev \\\\ .co.uk';
...
echo "<p>Email validation: " .
    filter_var($myEmail, FILTER_VALIDATE_EMAIL) . "</p>";
...
echo "<p>URL validation: " .
    filter_var($myURL, FILTER_VALIDATE_URL) . "</p>";
